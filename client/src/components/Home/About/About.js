      ...
      <div className="row">
        ...
        <div className="col-12 about-content">
          ...
          <p>
            ...
            Kshitij Tripathi, Soumyabrata Bairagi,Yash Pandey and Kartikey
            Rohila for thier initiative of blog space from which this project is
            inspired.You can ping any of the page admin requesting for any
            resource/section/notes that we missed to include here.
          </p>
        </div>
      </div>
    </div>
